...
- Create Angular project with ng: `ng new recrut.appliweb.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`recrut.appliweb.client.esproj`).
